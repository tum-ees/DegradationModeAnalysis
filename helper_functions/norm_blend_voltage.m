...
%> Date: 2025-09-11
%
% This function trims Blend1 and Blend2 to equal voltage max/min.
%
% INPUTS:
%   inStruct  - struct with `voltage` and `normalizedCapacity` fields
%   Vmin      - lower voltage bound of the common overlap region
%   Vmax      - upper voltage bound of the common overlap region
%
% OUTPUTS:
%   out       - trimmed input struct with renormalized capacity in [0, 1]
%
